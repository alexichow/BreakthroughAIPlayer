...
public class BreakthroughState extends GameState {
	...
	public static final Params gameParams = new Params("config"+ SEP + "breakthrough.txt");
	...
	public static final int NUM_CHILDREN = 42; // 14 pieces with a max of 3 moves per piece
	...
	public BreakthroughState(BreakthroughState oldState) {
		oldState.clone();
	}
	...
	public void undoMove(GameMove oldMove, char sym) {
		BreakthroughMove mv = (BreakthroughMove)oldMove;
		board[mv.startRow][mv.startCol] = sym;
		board[mv.endingRow][mv.endingCol] = emptySym;
	}
